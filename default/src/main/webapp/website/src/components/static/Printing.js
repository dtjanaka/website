  ...
  return (
    <>
      ...
      <div className='content'>
        ...
        <br />
        <a href={print1}>
          <img className='center responsive' src={print1} />
        </a>
        <p className='caption'>
